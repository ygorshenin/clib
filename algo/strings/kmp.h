...
// size |size|. |prefix| must be an array of size at least |size + 1|,
// and after function call prefix[i] will contain a length of a
// longest proper suffix of pattern[0, i) which is also a proper preix
// of pattern[0, i).
